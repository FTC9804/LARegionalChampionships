...
//renamed to TeleOp_9804_v8 on 2-24-16 at 4:06 PM by Etienne L.
//Fixed major driving bug--dealt with multiple set power statements.
//Untested version!!
...
//Renamed and rewritten to TournamentTeleOpV3 on 2-27-16 by Etienne L.
//uded opposite values for magnetic sensors
//reworote box and spinner controlling into one if statement
//switched extend and retract logic when getting states


public class TournamentTeleOpV3 extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.dpad_up || gamepad1.dpad_up) {      //moves arms and winches with d-pad buttons,
            ...
            armsSpeedError = currentArmsSpeed - targetArmsSpeed; // should be target - current
