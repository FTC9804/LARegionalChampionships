...
public class Auto_9804_Red_CloseStart_Ramp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        do {
            ...
            EncErrorLeft = targetEncoderCounts2 - currentEncCountLeft; //switch the order because our robot switched direction
        ...
        } while (EncErrorLeft < 0                   //error is less than 0 because the robot has switched directions
                && this.getRuntime() < 200);
