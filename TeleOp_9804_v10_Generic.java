...
public class TeleOp_9804_v4_variableGain extends OpMode {
    ...
    public void loop() {
        ...
        //Gets back and color value for gamepad to change box control
		...
		//Code for the scoring mech 
		if (gamepad1.b && redTeam) {
		
			sweepPosition = sweepOpened;
			
		}
		else if (gamepad1.x && blueTeam) {
		
			sweepPosition = SweepOpened;
			
		} else {
		
		speepPosition = sweepClosed;
